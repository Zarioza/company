...
Route::group([
    ...
    Route::get('/employees/superior/{employee:id}', [EmployeeController::class, 'findBySuperior'])->name('employee.superior.index');
    Route::get('/employees/position/{position:id}', [EmployeeController::class, 'findByPosition'])->name('employee.position.index');
});
